from BLL.art_generator import generate_ascii_art, generate_custom_symbol_art
from BLL.font_manager import get_available_fonts, is_valid_font
from BLL.color_manager import get_available_colors, is_valid_color
from DAL.file_handler import save_to_file
from Shared.utils import get_user_input
...
def start_console_interface():
    ...
    print("Доступні шрифти:", fonts[:19])  # Показуємо 19 перших шрифтів
